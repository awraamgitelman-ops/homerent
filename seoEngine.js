...
export function renderSeoPage(templateHtml, reqUrl = '/') {
  ...
  // 7. REQUISITES PAGE (/requisites)
    ...
    pageDesc = `Офіційні реєстраційні дані та реквізити ТОВ «НОВЕКС ІНВЕСТ» (ЄДРПОУ 43980756, комерційна назва АН «ФАВОРИТ ГРУП»). Юридична адреса: 36014, м. Полтава, вул. Європейська, 2, оф. 202. Офіс: вул. Соборності, 22.`;
