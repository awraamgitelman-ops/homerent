...
export const RoadmapSection = () => {
  const steps = [
    ...
    },
    {
      ...
      desc: 'Повна перевірка об\'єкта, арештів, обтяжень, співвласників, зареєстрованих осіб та історії приватизації.'
    },
    {
      num: '06',
      icon: FileText,
      title: 'Підготовка документів',
      desc: 'Оформлення експертної оцінки, витягів з реєстрів, довідок про відсутність заборгованостей.'
    },
    {
      num: '07',
      icon: Scale,
